...
# Каталог преподавателей и предметов группы К-311
SUBJECTS_DB = [
    {
...
SCHEDULE_DATA = {
    ...
    3: [
        ...
        {"hour": 12, "minute": 20, "time": "12:20 - 13:35", "title": "Інтернет речей та проектування розумного виробництва (пр) — Захаренков Д.Ю.", "link": "https://us02web.zoom.us/j/6696841684?pwd=eHR3aWV5RTIrWTRFYnFaejlWeXhkUT09", "service": "Zoom"},
    ],
    4: [
...
# Кнопки быстрого доступа с кнопкой обновления фото
...
def parse_and_update(message, file_id):
    temp_msg = bot.reply_to(message, "⏳ <b>Сканую розклад із файлу...</b>", parse_mode="HTML")
    try:
        ...
        if not found_pairs:
            bot.send_message(message.chat.id, "⚠️ Пари не розпізнано. Спробуй надіслати чіткіший файл.", reply_markup=get_main_keyboard())
            return
        ...
        bot.send_message(
            ...
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"Натисни кнопку <b>🗓 Весь тиждень</b> для перевірки.",
            parse_mode="HTML",
        ...
        try:
            ...
            pass
        bot.send_message(message.chat.id, f"❌ Помилка: {e}", reply_markup=get_main_keyboard())
...
def cmd_start(message):
    start_text = (
        ...
        "━━━━━━━━━━━━━━━━━━━━\n"
        "🚀 <b>Швидке керування кнопками знизу:</b>\n\n"
        "├ 🔴 <b>Зараз йде</b> — активна пара або скільки до наступної\n"
        "├ 🟡 <b>Сьогодні</b> — розклад на поточний день\n"
        "├ 🟠 <b>Завтра</b> — пари на завтрашній день\n"
        "├ 🗓 <b>Весь тиждень</b> — повний розклад\n"
        "└ 📸 <b>Оновити розклад</b> — завантажити новий скріншот\n"
        "━━━━━━━━━━━━━━━━━━━━"
    )
...
def handle_menu_buttons(message):
    if message.text == "🔴 Зараз йде":
        ...
        instruction = (
            "📸 <b>ЯК НАДІСЛАТИ СКРІНШОТ:</b>\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            "1. Натисни на <b>скріпку 📎</b> біля поля вводу.\n"
            "2. Оберіть <b>«Файл» ➔ «Фото або відео»</b> (щоб Telegram не стискав якість) або просто як звичайне фото.\n"
            "3. Надішли у цей чат — бот автоматично розпізнає пари та оновить розклад!"
        )
