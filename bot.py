...
# 100% точное расписание со скриншота группы К-311 (14 пар)
SCHEDULE_DATA = {
...
def cmd_start(message):
    start_text = (
        ...
        "━━━━━━━━━━━━━━━━━━━━\n"
        "Розклад зафіксовано строго за офіційним графіком!\n\n"
        "🚀 <b>Кнопки швидкого доступу:</b>\n"
        "├ 🔴 <b>Зараз йде</b> — точна поточна пара та таймер\n"
...
def handle_incoming_file(message):
    bot.reply_to(
        message,
        "📌 <b>Розклад зафіксовано вручну для точності.</b>\nЩоб змінити пари, просто надішли мені список змін у текстовому форматі.",
        parse_mode="HTML",
        reply_markup=get_main_keyboard()
    )
